    ...
    <form nz-form [formGroup]="form" (ngSubmit)="onSubmit()" nzLayout="vertical">
      <nz-spin [nzSpinning]="isValidating">
        <nz-form-item>
          ...
          <nz-form-control [nzErrorTip]="passwordErrorTpl" [nzValidatingTip]="'Validating...'">
            <input 
              nz-input 
              type="password" 
        ...
        <nz-form-item>
          ...
          <nz-form-control [nzErrorTip]="'Please select access level'">
            <nz-select formControlName="accessLevel" nzPlaceHolder="Select access level">
              <nz-option nzValue="full" nzLabel="Full Access"></nz-option>
              <nz-option nzValue="restricted" nzLabel="Restricted Access"></nz-option>
